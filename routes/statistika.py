...
def get_statistika(id:int=0,topic_id:int=0,question_id:int=0,topic_name:str=None,question_name:str=None,from_date:str=None,end_date:str=None,page:int=1,limit:int=5,status:bool=None,db: Session = Depends(get_db),current_user: UserCurrent = Depends(get_current_active_user)):

        return all_satatistikas(db=db,status=status,id=id,topic_id=topic_id,question_id=question_id,topic_name=topic_name,question_name=question_name,from_date=from_date,end_date=end_date,page=page,limit=limit)
